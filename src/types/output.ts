export type YieldMetric = 'ingot_pct' | 'dross_pct' | 'rejection_pct' | 'burn_loss_pct'

export const YIELD_METRICS: YieldMetric[] = ['ingot_pct', 'dross_pct', 'rejection_pct', 'burn_loss_pct']
