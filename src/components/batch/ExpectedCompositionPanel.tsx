  ...
  if (composition.length === 0) {
    return (
      <section className="rounded-2xl border border-dashed border-slate-600 p-5 text-center text-slate-400">
        <p>Add material lines to see expected composition</p>
        <p className="text-sm">अपेक्षित संरचना देखने के लिए सामग्री जोड़ें</p>
      </section>
    )
  }
  ...
  return (
    <section className="rounded-2xl border border-slate-700 bg-slate-800/60 p-5">
      ...
      <p className="mt-1 text-sm text-slate-400">
        ...
        <span className="block">केवल सलाह — सहेजने से नहीं रोकता</span>
      </p>
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-400">
                    {inSpec ? 'Within standard · मानक के अंदर' : 'Out of standard · मानक से बाहर'}
                  </p>
                </div>
              </div>
